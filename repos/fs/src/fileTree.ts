...
import { isFolder } from '@GFS/utils/isFolder'
import { limbo } from '@keg-hub/jsutils/limbo'
import { isFunc } from '@keg-hub/jsutils/isFunc'
import { throwError } from '@GFS/utils/throwError'
import { getRepoGobletDir } from '@gobletqa/goblet'
import { DefaultFileTreeExclude, DefaultFileExclude } from '@gobletqa/environment/constants'
...
export const buildFileTree = async (repo:Repo):Promise<TRootPaths> => {
  ...
  const searchOpts:TBuildFoundOpts = {
    full: true,
    recursive: true,
    exclude: DefaultFileTreeExclude,
  }
