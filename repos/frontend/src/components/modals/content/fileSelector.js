...
import { File } from 'GBAssets/icons/file'
...
import { CheckCircle } from 'GBAssets/icons/checkCircle'
import { createFile } from 'GBActions/files/api/createFile'
import { formatFileName } from 'GBUtils/helpers/formatFileName'
import { setActiveModal } from 'GBActions/modals/setActiveModal'
import { useFileGroups } from 'GBHooks/activeFile/useFileGroups'
import { ControlledAuto } from 'GBComponents/form/controlledAuto'
import { GobletButton } from 'GBComponents/buttons/button.restyle'
import { useFileTypeMeta } from 'GBHooks/activeFile/useFileTypeMeta'
import { setModalVisibility } from 'GBActions/modals/setModalVisibility'
import { useFileTypeOptions } from 'GBHooks/activeFile/useFileTypeOptions'
import { DisconnectRepoButton } from 'GBComponents/buttons/disconnectRepoButton'
