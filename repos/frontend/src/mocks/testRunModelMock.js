...
export const testRunModelMock = {
  ...
  running: false,
  command: 'bdd',
  params: ['context=tests/bdd/features/scrollSessions.feature', 'slowMo=5'],
  messages: {
    1616084165074: {
    ...
    1616084165474: {
      message:
        '$ node ./tasks/runTask.js bdd test context=tests/bdd/features/scrollSessions.feature slowMo=5\n',
      timestamp: 1616084165474,
      type: SOCKR_MSG_TYPES.STD_OUT,
    },
    1616084166213: {
      message:
        '==== Using previously-launched chromium on host machine... ====\n',
